      ...
      invoice_creation: {
        ...
        invoice_data: {
          ...
          metadata: {
            ...
            checkedBags: bookingData.passengerDetails?.checkedBags || '',
            carryOnBags: bookingData.passengerDetails?.carryOnBags || '',
            skiBags: bookingData.passengerDetails?.skiBags || '',
            vehicleType: bookingData.passengerDetails?.vehicleType || 'suv',
