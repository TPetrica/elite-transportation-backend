...
const createCheckoutSession = {
  body: Joi.object().keys({
    ...
    bookingData: Joi.object({
      ...
      distance: Joi.object({
        km: Joi.number().allow(null).optional(),
        miles: Joi.number().allow(null).optional(),
      }).allow(null).optional(),
      ...
      passengerDetails: Joi.object({
        ...
        checkedBags: Joi.alternatives().try(Joi.string(), Joi.number()).optional(),
        carryOnBags: Joi.alternatives().try(Joi.string(), Joi.number()).optional(),
        skiBags: Joi.alternatives().try(Joi.string(), Joi.number()).optional(),
        vehicleType: Joi.string().valid('sedan', 'suv').optional(),
